...
/**
 * Hoisted out of StatusBar so React doesn't create a new component type on
 * every render (which would defeat memoisation and trip react-hooks/static-components).
 */
